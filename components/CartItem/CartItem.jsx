    ...
    return (
        ...
        <motion.div ref={cartRef} className="cart_container" animate={isOpen ? "open" : "closed"} variants={variants} initial="closed">
            ...
            {state.items.length > 0 ? (
                    ...
                    {state.items.map((item, index) => (
                        ...
                        >
                            ...
                            <div className='flex flex-col justify-between w-full'>
                                ...
                                {item.variant && (
                                    <p className='text-gray text-xs font-bellfont leading-none'>Variant: {item.Variant}</p>
                                )}
                ...
                <p className='text-center font-bellfont'>Your cart is empty</p>
            )}
            {state.items.length > 0 && (
                ...
                <div className="checkout_form">
                    <motion.div className="bg-tertiary p-6 w-80" animate={showForm ? "formOpen" : "formClosed"} variants={variants} initial="formClosed">
                        ...
                        <form className="form_container">
                            ...
                            <button className="text-secondary uppercase p-2 font-bellfont" onClick={(e) => onHandleSubmit(e)}>Submit</button>
                        </form>
                    </motion.div>
                </div>
            )}
            {message && (
                <div className="msg_container">
                    <div className="cst_message">
                        ...
                        <p className="text-black text-base font-bellfont leading-tight">{message}</p>
                    </div>
                </div>
            )}
        </>
