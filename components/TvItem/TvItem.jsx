    ...
    <div className="flex flex-col items-center w-full">
        ...
        <div key={index} className="flex items-center justify-center w-full">
            <div className="flex-1 flex justify-end">
                <span className="text-secondary text-md leading-tight font-bellfont mt-2 text-lg pr-2">{item.channel}</span>
            </div>
            <div className="w-px h-10 bg-secondary"></div>
            <div className="flex-1 pl-2">
                <span className="text-secondary text-md leading-tight font-bellfont mt-2 text-lg">{item.name}</span>
            </div>
        </div>
        ))}
    </div>
